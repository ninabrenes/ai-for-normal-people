...
graph TD
    A[→ what do you need help with?] --> B[→ research & writing]
    A --> C[→ visual content]
    A --> D[→ building something]
    A --> E[→ repetitive tasks]
    
    B --> F[⟡ thinking partners<br/>chatgpt, claude]
    C --> G[⟡ creative assistants<br/>canva, dall-e]
    D --> H[⟡ building tools<br/>bolt.new, cursor]
    E --> I[⟡ automation tools<br/>zapier, make]
    ...
    style H fill:#0b1643,color:#ffffff
    style I fill:#0b1643,color:#ffffff
```
